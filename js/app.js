...
angular.module('ToDoApp', [])
    .config(function($httpProvider) {
        ...
        $httpProvider.defaults.headers.common['X-Parse-Application-Id'] = 'wW2io1P1Wdvv6CRmKg2EG9FLhFpbLJSBAxeWyL8I';
        $httpProvider.defaults.headers.common['X-Parse-REST-API-Key'] = 'yLMQ1PiDeYVj8UIcpdjUiQmbE8PloGkDEyTwPpvL';
    }).controller('TasksController', function($scope, $http) {
        $scope.refreshTasks = function() {
            $scope.loading = true;
            $http.get(tasksUrl + '?where={"done":false}').success(function(data) {
        ...
        $scope.newTasks = {done: false};


        $scope.addTask = function() {
            $http.post(tasksUrl, $scope.newTasks).success(function(responseData) {
                $scope.newTasks.objectId = responseData.objectId;
        ...
        $scope.updateTask = function(task) {
            ...
            $http.put(tasksUrl + '/' + task.objectId, task).success(function() {
